#
#  Be sure to run `pod spec lint BleshSDK.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "BleshSDK"
  s.version      = "3.2.1"
  s.summary      = "An iOS library to interact with Blesh beacons."
  ...
  # Or just: s.author    = "Bilgehan"
  # s.authors            = { "Bilgehan" => "" }
  # s.social_media_url   = "http://twitter.com/Bilgehan"
  ...
  s.source_files  = 'BleshSDK/BleshSDK.framework/Headers/*.h'
  ...
  # s.framework  = "SomeFramework"
   s.frameworks = "CoreBluetooth", "CoreLocation", "SystemConfiguration", "Accelerate", "AudioToolbox", "CoreTelephony"
